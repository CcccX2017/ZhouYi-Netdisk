...
insert into `tb_user_groups`(`group_id`, `group_name`, `parent_id`, `max_storage_space`, `max_file_size`, `gmt_create`,
                             `gmt_modified`)
values (1001, '普通用户', 0, 21474836480, 3221225472, '2021-01-20 19:33:33', '2021-01-20 19:33:33'),
