            ...
            <el-card class="box-card">
               ...
               <div class="file-list-parent" :style="fileListHeight">
                  ...
                  <div class="file-list" style="height: 314px">
                     <ul class="fileContainer clearfix" id="fileContainer" v-for="(item, index) in fileList"
                         :key="index">
                        <div class="clearfix file-box">
                           <li class="file-info file-name" :title="item.name">
                              <img :src="require('../../assets/filetype/' + item.icon)" :alt="item.name" width="25"
                           ...
                           <div class="file-operate">
                              <i class="iconfont icon-zanting" style="margin-right: 10px" v-if="!item.pause"
                                 title="暂停"></i>
